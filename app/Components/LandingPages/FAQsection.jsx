...
const faqs = [
  {
    ...
    answer: "Yes, our latest models come with IoT-enabled remote monitoring for real-time performance tracking.",
  },
  {
    question: "Can your machines be integrated with existing production lines?",
    answer: "Yes, our machines can be seamlessly integrated into existing conveyor systems and production setups.",
  },
  {
  ...
  
  {
    ...
    answer: "Our machines use Artificial Intelligence (AI), Machine Learning (ML), and advanced imaging technology to detect and separate materials based on color, shape, size, and defects.",
  },
];
  ...
  return (
    <section className="bg-gradient-to-r from-gray-100 to-white py-16 px-6 md:px-16">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-6xl font-bold text-gray-700">Frequently Asked <span className="text-[#9253FF]">Questions</span></h2>
      </div>
